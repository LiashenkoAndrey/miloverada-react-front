...
export function formatDate(someDateTimeStamp: string) {
    console.log("date", someDateTimeStamp)
...
export function formatDateWithTime(someDateTimeStamp: string) {
    return formatDate(someDateTimeStamp) + ` о ${new Date(someDateTimeStamp).toTimeString().substring(0, 5)}`
}
